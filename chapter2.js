...
async function runCommand(command) {
  ...
  if (consoleState === consoleStateTypes.AskWhoAreYou) {
    ...
    await delay(1000);
    await addToResponseText("1 w0nd3r, aft3r all that, d1d w3 3v3n succ33d?", "color:#d600ff;");
    await delay(1000);
    $('#command-history').html(' ');
    ...
    await delay(1000);
    await addToResponseText("Even n*w, you c@n't", "color:#001eff;");
    await delay(1000);
    ...
    if (georgeReOpen === 'Yes' || georgeReOpen === 'yes') {
      ...
      await delay(1000);
      await addToResponseText("4fter 4ll th4t h4ppened y0u just w4nt t0 f0rget 1t 4ll", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("1 supp0se y0u c0uld s4y 1 kn0w h0w t0 keep 4 de4l", "color:#d600ff;");
      await delay(1000);
    ...
    if (binaryCode === "01111001 01100101 01110011") {
      ...
      await delay(1000);
      await delay(1000);
      document.getElementById("hint-text").innerHTML = "01984";
      await delay(1000);
    ...
    if (nameUser === "Ashley" || nameUser === "Ash") {
      ...
      await delay(1000);
      await addToResponseText("But it seems like in this circumstance your daughter  is the one who came back"); //hide this
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("Th!s !s just @n*ther ex@mple *f why we h@ve t* get *ut *f here", "color:#001eff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("I'm sure it's fine");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("Th1s plac3 1s dang3r0us, and 1t's unl1k3ly any0n3 els3 1s h3r3", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("N*, but !t's just @bout our only ch*!ce", "color:#001eff;");
      await delay(1000);
      await addToResponseText("S*, wh@t d* y*u s@y,", "color:#001eff;");
      await delay(1000);
    ...
    if (helpOrNot === "yes" || helpOrNot === "Yes") {
      ...
      await delay(1000);
      await addToResponseText("When the t!me c*mes, you'll know what to d*", "color:#001eff;");
      await delay(1000);
      ...
      await addToResponseText("Th@t d*esn't surpr!se me", "color:#001eff;");
      await delay(1000);
    ...
    if (whoTurnOff === 'Ph' || whoTurnOff === "Phantom") {
      ...
      await delay(1000);
      await addToResponseText("But...", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("But, 1 h0p3 wh3n th3 t1m3 c0m3s, y0u w1ll r3m3mb3r what 1 d1d", "color:#d600ff;");
      await delay(1000);
    ...
    if (ghQuestions === "degrade" || ghQuestions === "Degrade") {
      ...
      await delay(1000);
      await addToResponseText("We're m4ch1nes n0w", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("1r0n1c4lly, the m0re we repl4y 0ur st0ry the m0re we f0rget them", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("1 ru1n3d what w3 built", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("Phant0m, h3 sa1d, h3 sa1d h3 w0uld t3ll th3 them what w3 d1d", "color:#d600ff;");
      await delay(1000);
      ...
      await delay(1000);
      await addToResponseText("1t w0uld b3 th3 man wh0 sav3d so m4ny oth3r's l1ve's", "color:#d600ff;");
      await delay(1000);
...
//Hidden Text=Blacklight, Hint text=Flashlight
